...
#[INITIALIZE]
dT = Dist_Tester(sample_size = 32000, reps = 1, nb_top = 20)
...
#TESTING MargD
# test_dist = distFun.MargD(num_std_moments = 6)
# batch_sizes = [8000]
...
# #test_parameters = [[0.01,0.1,1,10,100],[0.1,1,10],[0.1,1,10,100],[0.01,0.1,1,10],[1],[10],[100]]
# dT.opt_distance(test_dist,batch_sizes,test_parameters,'bandwidths',show_plots=True)
