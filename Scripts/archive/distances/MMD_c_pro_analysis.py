...
from distance_functions import CorrD
from distance_functions import MMD_c_pro
...
m_c=th.Tensor(pd.read_csv('./Data/archive/dat_calib_med.csv').sample(batch_size).values)
l_c=th.Tensor(pd.read_csv('./Data/archive/dat_calib_low.csv').sample(batch_size).values)    
